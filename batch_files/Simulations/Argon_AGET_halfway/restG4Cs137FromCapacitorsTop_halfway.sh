...
#SBATCH -J  SimCs137FromCapacitorsTop_halfway               # job name
#SBATCH -o  SimCs137FromCapacitorsTop_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 Cs137FromCapacitorsTop_halfway.rml