...
#SBATCH -J  SimCo60FromResistancesTop_halfway               # job name
#SBATCH -o  SimCo60FromResistancesTop_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 Co60FromResistancesTop_halfway.rml