...
#SBATCH -J  SimRa226FromResistancesTop_halfway               # job name
#SBATCH -o  SimRa226FromResistancesTop_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 Ra226FromResistancesTop_halfway.rml