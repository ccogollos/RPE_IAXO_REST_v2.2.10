...
#SBATCH -J  SimTh232FromCapacitorsBottom_halfway               # job name
#SBATCH -o  SimTh232FromCapacitorsBottom_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 Th232FromCapacitorsBottom_halfway.rml