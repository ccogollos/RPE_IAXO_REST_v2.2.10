...
#SBATCH -J  SimK40FromCapacitorsBottom_halfway               # job name
#SBATCH -o  SimK40FromCapacitorsBottom_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 K40FromCapacitorsBottom_halfway.rml