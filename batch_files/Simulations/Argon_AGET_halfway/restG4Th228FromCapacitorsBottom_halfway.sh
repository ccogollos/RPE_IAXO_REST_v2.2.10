...
#SBATCH -J  SimTh228FromCapacitorsBottom_halfway               # job name
#SBATCH -o  SimTh228FromCapacitorsBottom_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 Th228FromCapacitorsBottom_halfway.rml