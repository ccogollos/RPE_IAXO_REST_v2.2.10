...
#SBATCH -J  SimK40FromResistancesTop_halfway               # job name
#SBATCH -o  SimK40FromResistancesTop_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 K40FromResistancesTop_halfway.rml