...
#SBATCH -J  SimCs137FromCapacitorsBottom_halfway               # job name
#SBATCH -o  SimCs137FromCapacitorsBottom_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 Cs137FromCapacitorsBottom_halfway.rml