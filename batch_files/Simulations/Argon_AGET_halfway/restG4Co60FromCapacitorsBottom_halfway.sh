...
#SBATCH -J  SimCo60FromCapacitorsBottom_halfway               # job name
#SBATCH -o  SimCo60FromCapacitorsBottom_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 Co60FromCapacitorsBottom_halfway.rml