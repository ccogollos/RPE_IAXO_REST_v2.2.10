...
#SBATCH -J  SimTh228FromResistancesTop_halfway               # job name
#SBATCH -o  SimTh228FromResistancesTop_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 Th228FromResistancesTop_halfway.rml