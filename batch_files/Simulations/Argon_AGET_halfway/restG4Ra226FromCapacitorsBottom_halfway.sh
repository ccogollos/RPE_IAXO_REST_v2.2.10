...
#SBATCH -J  SimRa226FromCapacitorsBottom_halfway               # job name
#SBATCH -o  SimRa226FromCapacitorsBottom_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 Ra226FromCapacitorsBottom_halfway.rml